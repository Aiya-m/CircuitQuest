...
CIRCUITQUESTGAME_API UClass* Z_Construct_UClass_AShooterPickup();
...
CIRCUITQUESTGAME_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponTableRow();
...
class UScriptStruct* FWeaponTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FWeaponTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponTableRow, (UObject*)Z_Construct_UPackage__Script_CircuitQuestGame(), TEXT("WeaponTableRow"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"),&Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 398041832U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 4075674809U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_2263923072{
	TEXT("/Script/CircuitQuestGame"),
	Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_CircuitQuestGame_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
