...
CIRCUITQUESTGAME_API UClass* Z_Construct_UClass_AShooterCharacter();
CIRCUITQUESTGAME_API UClass* Z_Construct_UClass_AShooterCharacter_NoRegister();
CIRCUITQUESTGAME_API UClass* Z_Construct_UClass_UShooterWeaponHolder_NoRegister();
CIRCUITQUESTGAME_API UFunction* Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature();
...
struct Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics
{
	struct _Script_CircuitQuestGame_eventBulletCountUpdatedDelegate_Parms
	{
		int32 MagazineSize;
		int32 Bullets;
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_MagazineSize = { "MagazineSize", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_CircuitQuestGame_eventBulletCountUpdatedDelegate_Parms, MagazineSize), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_Bullets = { "Bullets", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_CircuitQuestGame_eventBulletCountUpdatedDelegate_Parms, Bullets), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_MagazineSize,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::NewProp_Bullets,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
// ********** End Delegate FBulletCountUpdatedDelegate Property Definitions ************************
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_CircuitQuestGame, nullptr, "BulletCountUpdatedDelegate__DelegateSignature", 	Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::PropPointers), 
sizeof(Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::_Script_CircuitQuestGame_eventBulletCountUpdatedDelegate_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::_Script_CircuitQuestGame_eventBulletCountUpdatedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_CircuitQuestGame_BulletCountUpdatedDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FBulletCountUpdatedDelegate_DelegateWrapper(const FMulticastScriptDelegate& BulletCountUpdatedDelegate, int32 MagazineSize, int32 Bullets)
{
	...
	_Script_CircuitQuestGame_eventBulletCountUpdatedDelegate_Parms Parms;
...
struct Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics
{
	struct _Script_CircuitQuestGame_eventDamagedDelegate_Parms
	{
		float LifePercent;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::NewProp_LifePercent = { "LifePercent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_CircuitQuestGame_eventDamagedDelegate_Parms, LifePercent), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::NewProp_LifePercent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
// ********** End Delegate FDamagedDelegate Property Definitions ***********************************
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_CircuitQuestGame, nullptr, "DamagedDelegate__DelegateSignature", 	Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::PropPointers), 
sizeof(Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::_Script_CircuitQuestGame_eventDamagedDelegate_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::_Script_CircuitQuestGame_eventDamagedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_CircuitQuestGame_DamagedDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FDamagedDelegate_DelegateWrapper(const FMulticastScriptDelegate& DamagedDelegate, float LifePercent)
{
	...
	_Script_CircuitQuestGame_eventDamagedDelegate_Parms Parms;
...
UObject* (*const Z_Construct_UClass_AShooterCharacter_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_ACircuitQuestGameCharacter,
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AShooterCharacter_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UShooterWeaponHolder_NoRegister, (int32)VTABLE_OFFSET(AShooterCharacter, IShooterWeaponHolder), false },  // 687279666
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_ShooterCharacter_h__Script_CircuitQuestGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterCharacter, AShooterCharacter::StaticClass, TEXT("AShooterCharacter"), &Z_Registration_Info_UClass_AShooterCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterCharacter), 2657940196U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_ShooterCharacter_h__Script_CircuitQuestGame_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_ShooterCharacter_h__Script_CircuitQuestGame_2537756888{
	TEXT("/Script/CircuitQuestGame"),
	Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_ShooterCharacter_h__Script_CircuitQuestGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iyara_OneDrive_Desktop_SeniorProject_CircuitQuest_CircuitQuestGame_Source_CircuitQuestGame_Variant_Shooter_ShooterCharacter_h__Script_CircuitQuestGame_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
